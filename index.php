...
<small>2 articulos seleccionados</small>
                                            <h5>SUBTOTAL: $440.00</h5>
                                        </div>
                                        <div class="cart-btns">
                                            <a href="index.php?modulo=carritoDeCompras">Ver carro</a>
		...
		if($modulo=="carritoDeCompras"){
                include_once "carritoDeCompras.php";
            }
		if($modulo=="pagar"){
                include_once "pagar.php";
            }
		if($modulo=="pagarTarjeta"){
                include_once "pagarTarjeta.php";
            }
        ?>
